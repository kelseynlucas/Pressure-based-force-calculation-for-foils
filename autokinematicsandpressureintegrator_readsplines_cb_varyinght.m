...
%calculator.  This version also uses foil height data to produce
%forces/torques in N and Nm, respectively, instead of per unit depth.  Foil
%height varies - for use with tail-shaped foil.
...
spldata = dlmread('F:\Nonunif_performance_PIV\Pressure code analysis\tail_mid\tail_heave_1.5Hz_1.5cm_0.3ms_mid\results_3cyc\splines_frm1-2000_incr10.txt');          %read in spline data file


pressfilestub = 'F:\Nonunif_performance_PIV\Pressure code analysis\tail_mid\tail_heave_1.5Hz_1.5cm_0.3ms_mid\results_3cyc\queen2_rodsim_dT10ms_';                                  % string prefix for pressure files

mov=VideoReader('F:\Nonunif_performance_PIV\Data_videos\tail\tail_heave_1.5Hz_1.5cm_0.3ms_mid.avi');          % read in movie
...
xlswrite('F:\Nonunif_performance_PIV\Pressure code analysis\tail_mid\tail_heave_1.5Hz_1.5cm_0.3ms_mid\results_3cyc\queen2_rodsim_dT10ms_xforce_fixed.xlsx',forcex)
xlswrite('F:\Nonunif_performance_PIV\Pressure code analysis\tail_mid\tail_heave_1.5Hz_1.5cm_0.3ms_mid\results_3cyc\queen2_rodsim_dT10ms_yforce_fixed.xlsx',forcey)
xlswrite('F:\Nonunif_performance_PIV\Pressure code analysis\tail_mid\tail_heave_1.5Hz_1.5cm_0.3ms_mid\results_3cyc\queen2_rodsim_dT10ms_torque_fixed.xlsx',torque)
movie2avi(M,'F:\Nonunif_performance_PIV\Pressure code analysis\tail_mid\tail_heave_1.5Hz_1.5cm_0.3ms_mid\results_3cyc\queen2_rodsim_dT10ms_cb_fixed.avi')